...
export class FortressBoss extends Phaser.GameObjects.Container {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number) {
    ...
    body.setDisplaySize(258, 288);
    mainCannon.setDisplaySize(168, 132);
    leftCannon.setDisplaySize(78, 86);
    rightCannon.setDisplaySize(78, 86);
    weakpoint.setDisplaySize(72, 72);
    damageOverlay.setDisplaySize(258, 288);
    wreck.setDisplaySize(258, 288);
    ...
    physicsBody.setSize(this.width * 0.86, this.height * 0.82);
